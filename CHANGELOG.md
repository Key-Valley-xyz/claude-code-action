...
## Fork Changes (Key-Valley-xyz/claude-code-action@main)
...
- **Updated Base Action**: Uses `Key-Valley-xyz/claude-code-base-action@main` which includes OAuth credential handling
